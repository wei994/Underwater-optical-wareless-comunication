...
% Zb = [60 90 120]
w_z0 = [3 4];
sigma_rp0 = [0.2:0.2:2];%linspace(0.2,2,10)
figure
%%
for i = 1:length(w_z0)
...
%%
% legend("L=60m Ptx1 = 0.01mW","L=90m, Ptx1 = 10 mW","L=120m,Ptx1 = 1W")
